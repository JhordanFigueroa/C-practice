...
//27. Operators - equality and assignment
//int main() {
////== test the condition of a value or conditions
//    int a;
//    int b;
//    a = 10;
//    b = 2;
...
//28. Operators- tests and comparisons
int main (int argc, char ** argv) {
    ...
    fgets(agestring,10, stdin); //stdin - standard input 
    age = atoi(agestring);
    if (age == 0) {
